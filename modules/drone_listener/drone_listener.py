...
try:
    while True:
        ...
        if parsed["type"] == "text":
            ...
            print(f"[<] {addr[0]} -> STICK: roll={parsed['stick']['roll']} pitch={parsed['stick']['pitch']} throttle={parsed['stick']['throttle']} yaw={parsed['stick']['yaw']} fast_mode={parsed['stick']['fast_mode']}")
        else:
