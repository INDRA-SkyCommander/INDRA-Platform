...
class mpsk_stage1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rate = samp_rate = 20e6 #Mayhem: 3072000U
        ...
        self.osmosdr_sink_0.set_gain(20, 0) #Mayhem: 47
        self.osmosdr_sink_0.set_if_gain(20, 0)
        self.osmosdr_sink_0.set_bb_gain(20, 0)
        self.osmosdr_sink_0.set_antenna('', 0)
        self.osmosdr_sink_0.set_bandwidth(0, 0) #Do we need to set this bandwidth??
