...
class mpsk_stage1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_sink_0.set_center_freq(2400000000)
        ...
        self.osmosdr_sink_0.set_bandwidth(10e6) #TODO do we need to set anything here?
...
def main(top_block_cls=mpsk_stage1, options=None):
    ...
    def change_frequency():
       ...
       #frequencies = [2410e6, 2413e6, 2416e6, 2419e6, 2422e6, 2425e6, 2442e6, 2432e6, 2427e6, 2437e6, 2430e6, 2435e6, 2440e6, 2445e6, 2448e6, 2451e6, 2454e6, 2457e6, 2460e6]
       #frequencies = [2400e6, 2403e6, 2406e6, 2409e6, 2412e6, 2415e6, 2418e6, 2421e6, 2424e6, 2427e6, 2430e6, 2433e6, 2436e6, 2439e6, 2442e6, 2445e6]
       frequencies = [2403e6, 2406e6, 2409e6, 2412e6, 2415e6, 2418e6, 2421e6, 2424e6, 2427e6, 2430e6] #Channel 1
       #frequencies = [2418e6, 2421e6, 2424e6, 2427e6, 2430e6, 2433e6, 2436e6, 2439e6, 2442e6] #Channel 2
       #frequencies = [2465e5, 2450e6, 2460e6, 2445e6, 2455e6, 2442e6, 2448e6, 2462e6, 2458e6, 2453e6, 2468e6, 2470e6, 2473e6, 2475e6, 2477e6, 2480e6] #Channel 3

       while True:
            for freq in frequencies:
                tb.set_Center_Frequency(freq)
               # time.sleep(0.000625)  # Adjust sleep time as needed
